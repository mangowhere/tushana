 ...
 */
public class PhotoReader extends GenericReader<Photo> {

    @Override
    public GenericSelect createSelect() {
        return new PhotoSelect();
    }

    @Override
    public GenericSelect<Photo> createSelect(Photo t) {
        return new PhotoSelect(t);
    }
    
    
    public Photo getById(String photoId) {
        GenericSelect<Photo> select = createSelect();
    ...
    @Override
    public ArrayList<Photo> find(Photo t) {
        GenericSelect<Photo> select = createSelect();
