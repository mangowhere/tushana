 ...
 */
public class PkReader extends GenericReader<Pk> {
    ...
    @Override
    public GenericSelect<Pk> createSelect(Pk t) {
        return new PkSelect(t);
    }

    @Override
    public ArrayList<Pk> find(Pk t) {
        GenericSelect<Pk> select = createSelect();

        ResultSet rs = null;
        PreparedStatement ps = null;
        Connection conn = null;

        ArrayList<Pk> ret = null;
        try {
